...
<nav>
      ...
      <div class="bottom-Nav px-10 py-7 flex items-center gap-6">
        ...
        <div class="flex items-center gap-5 shrink-0 ml-20 mr-11">
...
const navHtml = document.getElementById("navbar") as HTMLDivElement
if (navHtml) {
    navHtml.innerHTML = navigationBar
}
